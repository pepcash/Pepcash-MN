...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PepCashNetwork") type = PepCashNetwork;
    if(strType == "PepCashNetworkVariable") type = PepCashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PepCashNetwork) s = "PepCashNetwork";
    if(type == PepCashNetworkVariable) s = "PepCashNetworkVariable";
