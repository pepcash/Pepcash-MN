 ...
 *
 *   // network
 *   CPepCashNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CPepCashNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CPepCashNetwork(UniValue objIn)
    {
...
// // can be under: PepCashNetwork
// //   -- signature requirements : Key1(User)
// class CPepCashNetworkVariable : public CGovernanceObject
// {
// private:
