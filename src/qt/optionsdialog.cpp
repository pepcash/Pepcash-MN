    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PCH-light"), QVariant("light"));
    ui->theme->addItem(QString("PCH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PCH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PCH-traditional"), QVariant("trad"));
