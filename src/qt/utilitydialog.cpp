    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("PepCash Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About PepCash Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  pepcash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the PepCash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PCH, 0.1 PCH, 1 PCH and 10 PCH -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://www.pepcash.com\">www.pepcash.com</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("PepCash Core is shutting down...") + "<br /><br />" +
