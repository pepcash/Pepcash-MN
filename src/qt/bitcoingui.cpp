    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("PepCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PepCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pepcash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About PepCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about PepCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PepCash Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PepCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PepCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a pepcash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PepCash Core help message to get a list with possible PepCash Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("PepCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PepCash network", "", count));
}
...
{
    QString strTitle = tr("PepCash Core"); // default title
