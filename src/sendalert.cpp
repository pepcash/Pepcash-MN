...
2. run pepcashd with -printalert or -sendalert like this:
   /path/to/pepcashd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.pepcash.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/PepCash Core:0.12.0.58/"));
