...
{
    if(fLiteMode) return; // ignore all PepCash related functionality
...
/*
    ...
    allow endless transaction that would bloat PepCash and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("pepcash-privatesend");
