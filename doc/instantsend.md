...
This mechanism has been integrated into Bitcore-Node-PepCash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/pepcash/insight-api-pepcash#web-socket-api](https://github.com/pepcash/insight-api-pepcash#web-socket-api)
* API: [https://github.com/pepcash/insight-api-pepcash#instantsend-transactions](https://github.com/pepcash/insight-api-pepcash#instantsend-transactions)
...
By default, the PepCash Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PepCash Core daemon:
