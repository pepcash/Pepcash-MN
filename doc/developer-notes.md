...
PepCash Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as PepCash Core, where everyone uses
...
pay attention to for reviewers of PepCash Core code.

General PepCash Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: PepCash Core uses tinyformat, which is type safe. Leave them out to avoid confusion
