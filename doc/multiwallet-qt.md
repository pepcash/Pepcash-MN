...
Only requiring some minor changes is pepcash.cpp.
...
Changes to pepcash.cpp
----------------------
pepcash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
